...
public static class Move
{
    ...
    */
    ...
    public static void DisplayMoveInformation(int move)
    {
        ...
        Console.WriteLine($"Start {Square.ConvertIndexToSquareName(startIndex)} | End {Square.ConvertIndexToSquareName(endIndex)} | MoveType {moveType} | movedPiece {movedPiece} | capturedPiece {capturedPiece}");
    }
}